...
<script>
  ...
  export default {
    ...
    methods: {
      ...
      exportReport() {
        location.href = this.$global.fileUrl + '/orderPlacingMeeting/opmOrderController/exportOpmOrderPickupReport?opMeetingId=' + this.opMeetingInfo.opMeetingId + '&commonRegionId=' + this.commonRegionId;
      },
      pageChanged(curPage) {
