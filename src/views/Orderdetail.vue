<template>
  <div class="order_pickup-goods-confirm">
    ...
    <div class="order-pay-info box-1200">
      <p class="p1"><label>订单付款状态：</label><span class="payment-status">{{orderPickGoodsInfo.paymentStatusCdName}}</span>
      </p>
...
<script>
  ...
  export default {
    name: 'Orderdetail',
    created() {
      this.orderPickGoodsInfo = JSON.parse(sessionStorage.getItem('orderDetail'));
