...
<script>
  ...
  export default {
    ...
    computed: {
      offerPicUrl() {
        return _.get(this.data, 'offerPic.offerPicUrl') ? 'http://192.168.74.17:9086/orderPlacingMeeting/commonCfgController/download?url=' + _.get(this.data, 'offerPic.offerPicUrl') : './static/img/icon-tel-default.jpg'
      },
      policyList() {
