  ...
  <div class="v_order-menu">
    <el-menu :default-active="$route.path" class="fn-right" mode="horizontal" router>
      ...
      <el-submenu index="2">
        ...
        <el-menu-item index="/order/orderModel" :disabled="this.opMeetingInfo.statusCd === '1001' || this.opMeetingInfo.statusCd === '1002'">机型维护</el-menu-item>
        ...
        <el-menu-item index="/order/specialModel" :disabled="this.opMeetingInfo.statusCd === '1001' || this.opMeetingInfo.statusCd === '1002'">特种机型分配量维护</el-menu-item>
        <el-menu-item index="/order/importSpecialModel" style="display: none;">特种机型导入新增</el-menu-item>
      </el-submenu>
      <el-submenu index="3">
        <template slot="title">订单管理</template>
        <el-menu-item index="/order/importPickupAdd" :disabled="this.opMeetingInfo.statusCd === '1001' || this.opMeetingInfo.statusCd === '1002'">订单批量导入</el-menu-item>
        <el-menu-item index="/order/orderPickupData" :disabled="this.opMeetingInfo.statusCd === '1000'">订单提货数据维护</el-menu-item>
      ...
      <el-submenu index="4">
        ...
        <el-menu-item index="/order/cyjDepositAddRecord" :disabled="this.opMeetingInfo.statusCd === '1000'">诚意金补录</el-menu-item>
      </el-submenu>
      <el-submenu index="5">
        <template slot="title">政策管理</template>
        <el-menu-item index="/order/policyManage" :disabled="this.opMeetingInfo.statusCd === '1001' || this.opMeetingInfo.statusCd === '1002'">政策投入</el-menu-item>
        <el-menu-item index="/order/importPolicyAdd" style="display: none;">上传政策</el-menu-item>
        <el-menu-item index="/order/policyList" :disabled="this.opMeetingInfo.statusCd === '1001' || this.opMeetingInfo.statusCd === '1002'">政策列表</el-menu-item>
        <el-menu-item index="/order/policyExamine" :disabled="this.opMeetingInfo.statusCd === '1001' || this.opMeetingInfo.statusCd === '1002'">政策审核</el-menu-item>
      </el-submenu>
      <el-submenu index="/order/orderCompositeQuery">
        ...
        <el-menu-item index="/order/preferentialPolicySettlement" :disabled="this.opMeetingInfo.statusCd === '1000'">优惠政策结算</el-menu-item>
